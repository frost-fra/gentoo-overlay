...
SRC_URI="http://downloads.slimdevices.com/LogitechMediaServer_v8.0.0/logitechmediaserver-8.0.0-noCPAN.tgz"
...
S="${WORKDIR}/logitechmediaserver-8.0.0-noCPAN"
...
#	cp -r CPAN/arch "${D}/usr/lib/squeezeboxserver/CPAN" || die "Unable to install compiled CPAN modules"
	...
	elog "/usr/share/doc/logitechmediaserver-8.0.0/"
	elog "unterhalb des Ordners"
	elog "/var/tmp/portage/media-sound/logitechmediaserver-8.0.0/image/"
	elog ""
	...
	if [ ! -f "${PREFSDIR}/logitechmediaserver.prefs" ]; then
		...
		elog "in das Verzeichnis /var/tmp/portage/media-sound/logitechmediaserver-8.0.0/image/${PREFSDIR} ein"
	...
	elog "/var/tmp/portage/media-sound/logitechmediaserver-8.0.0/image/var/run/logitechmediaserver"
	elog ""
	...
	elog "/var/tmp/portage/media-sound/logitechmediaserver-8.0.0/image/var/lib/logitechmediaserver/cache"
	elog ""
	...
	elog "/var/tmp/portage/media-sound/logitechmediaserver-8.0.0/image/var/log/logitechmediaserver"
	elog ""
	...
	elog "Im Verzeichnis: /var/tmp/portage/media-sound/logitechmediaserver-8.0.0/image/"
	elog ""
	dodir "${PLUGINSDIR}"
