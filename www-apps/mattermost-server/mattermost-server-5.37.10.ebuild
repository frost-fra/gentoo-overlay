...
GIT_COMMIT="b5920e093103460b567834d7158019b8266a66b5"
WEBAPP_COMMIT="2d4467939ee550122ac8e9d4f0acc26798d1ed39"
...
src_prepare() {
	...
	einfo "mygoargs sind ${mygoargs[@]}"
        ...
        OUTPUT_CONFIG="${S}/config/default.json" go "${mygoargs[@]}" run ./scripts/config_generator || die
